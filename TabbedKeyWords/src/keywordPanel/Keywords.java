...
public class Keywords extends JFrame {
	...
	public void addComponentsToPane(final Container pane) {
		...
		compsToExperiment.setLayout(new GridLayout(5,1));
	...
	public void addFirstPane(final Container pane, Keywords frame) {
		final JPanel RefPane = new JPanel();
		RefPane.setLayout(new GridLayout(1,2));
		
		//Set up the content pane.
		RefPane.add(frame.addComponentsToPane(RefPane));
